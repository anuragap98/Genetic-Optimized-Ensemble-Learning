...
def load_crime_dataset():
    ...
    crime = pd.read_table('CommViolPredUnnormalizedData.txt', na_values='?')
    # remove features with poor coverage or lower relevance, and keep ViolentCrimesPerPop target column
    columns = [5, 6] + list(range(9,26)) + list(range(88,103)) + [145]
...
def plot_multi_model(n_neighbors,gamma,kernel,max_depth):
    ...
    clf2 = KNeighborsClassifier(n_neighbors)
    clf3 = SVC(gamma, kernel, probability=True)
